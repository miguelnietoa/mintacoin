...
#   - Ex: hexpm/elixir:1.14.0-erlang-24.3-debian-bullseye-20210902-slim
#
...
ARG BUILDER_IMAGE="hexpm/elixir:1.14.0-erlang-24.3-debian-bullseye-20210902-slim"
...
COPY --from=builder --chown=nobody:root /app/_build/${MIX_ENV}/rel/mintacoin ./
